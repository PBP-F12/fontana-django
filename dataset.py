from auths.forms import AuthorRegistrationForm, AdminRegistrationForm
...
admin_form = AdminRegistrationForm(
    {"full_name": "Admin", "username": "admin", "password1": "halo123", "password2": "halo123"})
admin_form.save()

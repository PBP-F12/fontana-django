...
author_form = AuthorRegistrationForm({"username": "harperlee", "password1": "halo123", "password2": "halo123"})
...
author_form = AuthorRegistrationForm({"username": "janeausten", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("janeausten")
print("Pride and Prejudice")
book = Book(author_id=author_instance, book_title="Pride and Prejudice", description='Since its immediate success in 1813, Pride and Prejudice has remained one of the most popular novels in the English language. Jane Austen called this brilliant work "her own darling child" and its vivacious heroine, Elizabeth Bennet, "as delightful a creature as ever appeared in print." The romantic clash between the opinionated Elizabeth and her proud beau, Mr. Darcy, is a splendid performance of civilized sparring. And Jane Austen\u0027s radiant wit sparkles as her characters dance a delicate quadrille of flirtation and intrigue, making this book the most superb comedy of manners of Regency England.Alternate cover edition of ISBN 9780679783268', avg_rating=4.28, num_rating=3944155, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1320399351i/1885.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "annefrank", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("annefrank")
...
author_form = AuthorRegistrationForm({"username": "georgeorwell", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("georgeorwell")
print("Animal Farm")
...
author_form = AuthorRegistrationForm({"username": "antoinedesaint_exupery", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "j.r.r.tolkien", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("j.r.r.tolkien")
...
author_form = AuthorRegistrationForm({"username": "markuszusak", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("markuszusak")
...
book = Book(author_id=author_instance, book_title="The Lion, the Witch and the Wardrobe (Chronicles of Narnia, #1)", description='Narnia… the land beyond the wardrobe door, a secret place frozen in eternal winter, a magical country waiting to be set free.Lucy is the first to find the secret of the wardrobe in the professor\u0027s mysterious old house. At first her brothers and sister don\u0027t believe her when she tells of her visit to the land of Narnia. But soon Edmund, then Peter and Susan step through the wardrobe themselves. In Narnia they find a country buried under the evil enchantment of the White Witch. When they meet the Lion Aslan, they realize they\u0027ve been called to a great adventure and bravely join the battle to free Narnia from the Witch\u0027s sinister spell.', avg_rating=4.23, num_rating=2620424, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1353029077i/100915.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "williamgolding", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "loislowry", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("loislowry")
print("The Giver (The Giver, #1)")
book = Book(author_id=author_instance, book_title="The Giver (The Giver, #1)", description='At the age of twelve, Jonas, a young boy from a seemingly utopian, futuristic world, is singled out to receive special training from The Giver, who alone holds the memories of the true joys and pain of life.', avg_rating=4.12, num_rating=2285401, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1342493368i/3636.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "shelsilverstein", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("shelsilverstein")
print("The Giving Tree")
book = Book(author_id=author_instance, book_title="The Giving Tree", description='Once there was a tree...and she loved a little boy."So begins a story of unforgettable perception, beautifully written and illustrated by the gifted and versatile Shel Silverstein.Every day the boy would come to the tree to eat her apples, swing from her branches, or slide down her trunk...and the tree was happy. But as the boy grew older he began to want more from the tree, and the tree gave and gave and gave.This is a tender story, touched with sadness, aglow with consolation. Shel Silverstein has created a moving parable for readers of all ages that offers an affecting interpretation of the gift of giving and a serene acceptance of another\u0027s capacity to love in return.', avg_rating=4.38, num_rating=1067524, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1174210942i/370493.jpg")
print('save')
book.save()
...
author_form = AuthorRegistrationForm({"username": "e.b.white", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("e.b.white")
...
author_form = AuthorRegistrationForm({"username": "louisamayalcott", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "suzannecollins", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "johnsteinbeck", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("johnsteinbeck")
...
author_form = AuthorRegistrationForm({"username": "raybradbury", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("raybradbury")
...
author_form = AuthorRegistrationForm({"username": "dr.seuss", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("dr.seuss")
...
author_form = AuthorRegistrationForm({"username": "emilybronte", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("emilybronte")
...
author_form = AuthorRegistrationForm({"username": "marktwain", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("marktwain")
print("The Adventures of Huckleberry Finn")
book = Book(author_id=author_instance, book_title="The Adventures of Huckleberry Finn", description='A nineteenth-century boy from a Mississippi River town recounts his adventures as he travels down the river with a runaway slave, encountering a family involved in a feud, two scoundrels pretending to be royalty, and Tom Sawyer\u0027s aunt who mistakes him for Tom.', avg_rating=3.83, num_rating=1237071, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1546096879i/2956.jpg")
print('save')
book.save()
...
author_form = AuthorRegistrationForm({"username": "kathrynstockett", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "franceshodgsonburnett", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "charlesdickens", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "gabrielgarciamarquez", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("gabrielgarciamarquez")
print("One Hundred Years of Solitude")
book = Book(author_id=author_instance, book_title="One Hundred Years of Solitude", description='The brilliant, bestselling, landmark novel that tells the story of the Buendia family, and chronicles the irreconcilable conflict between the desire for solitude and the need for love-in rich, imaginative prose that has come to define an entire genre known as "magical realism.', avg_rating=4.11, num_rating=911512, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1327881361i/320.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "l.m.montgomery", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "alexandredumas", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "orsonscottcard", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "mauricesendak", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("mauricesendak")
print("Where the Wild Things Are")
book = Book(author_id=author_instance, book_title="Where the Wild Things Are", description='Max, a wild and naughty boy, is sent to bed without his supper by his exhausted mother. In his room, he imagines sailing far away to a land of Wild Things. Instead of eating him, the Wild Things make Max their king.', avg_rating=4.24, num_rating=963323, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1384434560i/19543.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "alicewalker", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("alicewalker")
...
author_form = AuthorRegistrationForm({"username": "yannmartel", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("yannmartel")
print("Life of Pi")
book = Book(author_id=author_instance, book_title="Life of Pi", description='Life of Pi is a fantasy adventure novel by Yann Martel published in 2001. The protagonist, Piscine Molitor "Pi" Patel, a Tamil boy from Pondicherry, explores issues of spirituality and practicality from an early age. He survives 227 days after a shipwreck while stranded on a boat in the Pacific Ocean with a Bengal tiger named Richard Parker.', avg_rating=3.93, num_rating=1552035, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1631251689i/4214.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "margaretatwood", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "kenkesey", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("kenkesey")
...
author_form = AuthorRegistrationForm({"username": "mitchalbom", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("mitchalbom")
...
author_form = AuthorRegistrationForm({"username": "a.a.milne", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("a.a.milne")
print("Winnie-the-Pooh (Winnie-the-Pooh #1)")
book = Book(author_id=author_instance, book_title="Winnie-the-Pooh (Winnie-the-Pooh #1)", description='The adventures of Christopher Robin and his friends in which Pooh Bear uses a balloon to get honey, Piglet meets a Heffalump, and Eeyore has a birthday.', avg_rating=4.35, num_rating=313861, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1298440130i/99107.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "kurtvonnegutjr.", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("kurtvonnegutjr.")
print("Slaughterhouse-Five")
book = Book(author_id=author_instance, book_title="Slaughterhouse-Five", description='Selected by the Modern Library as one of the 100 best novels of all time, Slaughterhouse-Five, an American classic, is one of the world\u0027s great antiwar books. Centering on the infamous firebombing of Dresden, Billy Pilgrim\u0027s odyssey through time reflects the mythic journey of our own fractured lives as we search for meaning in what we fear most.', avg_rating=4.09, num_rating=1302806, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1440319389i/4981.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "ernesthemingway", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("ernesthemingway")
print("The Old Man and the Sea")
book = Book(author_id=author_instance, book_title="The Old Man and the Sea", description='Librarian\u0027s note: An alternate cover edition can be found hereThis short novel, already a modern classic, is the superbly told, tragic story of a Cuban fisherman in the Gulf Stream and the giant Marlin he kills and loses-specifically referred to in the citation accompanying the author\u0027s Nobel Prize for literature in 1954.', avg_rating=3.8, num_rating=1060714, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1329189714i/2165.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "josephheller", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("josephheller")
print("Catch-22")
...
author_form = AuthorRegistrationForm({"username": "audreyniffenegger", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("audreyniffenegger")
print("The Time Traveler's Wife")
book = Book(author_id=author_instance, book_title="The Time Traveler's Wife", description='This is the extraordinary love story of Clare and Henry, who met when Clare was six and Henry was thirty-six, and were married when Clare was twenty-two and Henry was thirty. Impossible but true, because Henry suffers from a rare condition where his genetic clock periodically resets and he finds himself pulled suddenly into his past or future. In the face of this force they can neither prevent nor control, Henry and Clare\u0027s struggle to lead normal lives is both intensely moving and entirely unforgettable.', avg_rating=3.99, num_rating=1736216, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1380660571i/18619684.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "hermannhesse", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("hermannhesse")
print("Siddhartha")
book = Book(author_id=author_instance, book_title="Siddhartha", description='Herman Hesse\u0027s classic novel has delighted, inspired, and influenced generations of readers, writers, and thinkers. In this story of a wealthy Indian Brahmin who casts off a life of privilege to seek spiritual fulfillment. Hesse synthesizes disparate philosophies--Eastern religions, Jungian archetypes, Western individualism--into a unique vision of life as expressed through one man\u0027s search for true meaning.', avg_rating=4.06, num_rating=720467, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1629378189i/52036.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "albertcamus", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("albertcamus")
print("The Stranger")
book = Book(author_id=author_instance, book_title="The Stranger", description='Published in 1942 by French author Albert Camus, The Stranger has long been considered a classic of twentieth-century literature. Le Monde ranks it as number one on its "100 Books of the Century" list. Through this story of an ordinary man unwittingly drawn into a senseless murder on a sundrenched Algerian beach, Camus explores what he termed "the nakedness of man faced with the absurd.', avg_rating=4.01, num_rating=960905, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1590930002i/49552.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "margaretwisebrown", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("margaretwisebrown")
print("Goodnight Moon")
book = Book(author_id=author_instance, book_title="Goodnight Moon", description='In a great green room, tucked away in bed, is a little bunny. "Goodnight room, goodnight moon." And to all the familiar things in the softly lit room -- to the picture of the three little bears sitting on chairs, to the clocks and his socks, to the mittens and the kittens, to everything one by one -- the little bunny says goodnight.In this classic of children\u0027s literature, beloved by generations of readers and listeners, the quiet poetry of the words and the gentle, lulling illustrations combine to make a perfect book for the end of the day.', avg_rating=4.3, num_rating=358773, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1439223893i/32929.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "bettysmith", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("bettysmith")
...
author_form = AuthorRegistrationForm({"username": "lauraingallswilder", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "anthonyburgess", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("anthonyburgess")
print("A Clockwork Orange")
book = Book(author_id=author_instance, book_title="A Clockwork Orange", description='In Anthony Burgess\u0027s influential nightmare vision of the future, criminals take over after dark. Teen gang leader Alex narrates in fantastically inventive slang that echoes the violent intensity of youth rebelling against society. Dazzling and transgressive, A Clockwork Orange is a frightening fable about good and evil and the meaning of human freedom. This edition includes the controversial last chapter not published in the first edition, and Burgess\u2019s introduction, "A Clockwork Orange Resucked."', avg_rating=4, num_rating=681585, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1549260060i/41817486.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "erichmariaremarque", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("erichmariaremarque")
print("All Quiet on the Western Front")
book = Book(author_id=author_instance, book_title="All Quiet on the Western Front", description='One by one the boys begin to fall…In 1914 a room full of German schoolboys, fresh-faced and idealistic, are goaded by their schoolmaster to troop off to the ‘glorious war\u2019. With the fire and patriotism of youth they sign up. What follows is the moving story of a young ‘unknown soldier\u2019 experiencing the horror and disillusionment of life in the trenches.', avg_rating=4.05, num_rating=427431, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1632027397i/355697.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "stephenking", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("stephenking")
print("The Stand")
book = Book(author_id=author_instance, book_title="The Stand", description='First came the days of the plague. Then came the dreams. Dark dreams that warned of the coming of the dark man. The apostate of death, his worn-down boot heels tramping the night roads. The warlord of the charnel house and Prince of Evil. His time is at hand. His empire grows in the west and the Apocalypse looms.For hundreds of thousands of fans who read The Stand in its original version and wanted more, this new edition is Stephen King\u0027s gift. And those who are listening to The Stand for the first time will discover a triumphant and eerily plausible work of the imagination that takes on the issues that will determine our survival.', avg_rating=4.34, num_rating=722312, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1213131305i/149267.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "migueldecervantessaavedra", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
...
author_form = AuthorRegistrationForm({"username": "barbarakingsolver", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("barbarakingsolver")
print("The Poisonwood Bible")
book = Book(author_id=author_instance, book_title="The Poisonwood Bible", description='The Poisonwood Bible is a story told by the wife and four daughters of Nathan Price, a fierce, evangelical Baptist who takes his family and mission to the Belgian Congo in 1959. They carry with them everything they believe they will need from home, but soon find that all of it -- from garden seeds to Scripture -- is calamitously transformed on African soil. What follows is a suspenseful epic of one family\u0027s tragic undoing and remarkable reconstruction over the course of three decades in postcolonial Africa.', avg_rating=4.09, num_rating=716880, book_cover_link="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1644073807i/7244.jpg")
print('save')
book.save()

author_form = AuthorRegistrationForm({"username": "mayaangelou", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("mayaangelou")
...
author_form = AuthorRegistrationForm({"username": "josephsmithjr.", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
print("josephsmithjr.")
...
author_form = AuthorRegistrationForm({"username": "hermanmelville", "password1": "halo123", "password2": "halo123"})
author_instance = author_form.save()
